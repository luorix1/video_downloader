...
do
    ...
    python3 crawl_lol.py --url $highlight --output_dir {YOUR_OUTPUT_DIR} --filename $highlight_name
    python3 crawl_lol.py --url $full --output_dir {YOUR_OUTPUT_DIR} --filename $full_name
